...
func (m *MockDBInterface) AllArticles() ([]models.Articles, error) {
	m.ctrl.T.Helper()
...
func (m *MockDBInterface) CreateArticle(article *models.Articles) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockDBInterface) OneArticle(id int) (*models.Articles, error) {
	m.ctrl.T.Helper()
